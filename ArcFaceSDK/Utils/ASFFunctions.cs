...
namespace ArcFaceSDK.Utils
{
    ...
    public class ASFFunctions
    {
        ...
        /// <param name="activeKey">SDK对应的ACTIVEKEY</param>
        /// <returns>调用结果</returns>
        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <returns>调用结果</returns>
        [DllImport(Dll_PATH, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ASFImageQualityDetectEx(IntPtr hEngine, IntPtr imgData, IntPtr detectedFaces, IntPtr imageQualityInfo, ASF_DetectModel detectModel = ASF_DetectModel.ASF_DETECT_MODEL_RGB);
